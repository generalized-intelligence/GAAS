...
class Px4Controller:
    ...
    def __init__(self):
        ...
        self.set_target_velocity_sub = rospy.Subscriber("/uav1/gi/set_pose/velocity", Vector3Stamped, self.set_target_velocity_callback)
        ...
        ros publishers
        '''
        self.pose_target_pub = rospy.Publisher('/uav1/mavros/setpoint_position/local', PoseStamped, queue_size=10)
        self.twist_target_pub = rospy.Publisher('/uav1/mavros/setpoint_velocity/cmd_vel', TwistStamped, queue_size=10)
    ...
    def set_target_velocity_callback(self, msg):
        ...
        if msg.header.frame_id == 'base_link':
            ...
            #self.cur_target_pose = self.cur_target_pose(vx=ENU_vx,vy=ENU_vy,vz=ENU_vz)
