...
class Px4Controller:
    ...
    def __init__(self):
        ...
        self.set_target_velocity_sub = rospy.Subscriber("/uav2/gi/set_pose/velocity", Vector3Stamped, self.set_target_velocity_callback)
        ...
        ros publishers
        '''
        self.pose_target_pub = rospy.Publisher('/uav2/mavros/setpoint_position/local', PoseStamped, queue_size=10)
        self.twist_target_pub = rospy.Publisher('/uav2/mavros/setpoint_velocity/cmd_vel', TwistStamped, queue_size=10)
    ...
    def start(self):
        rospy.init_node("uav2_offboard_node")
    ...
    def set_target_velocity_callback(self, msg):
        ...
        if msg.header.frame_id == 'base_link':
            ...
            ENU_vx, ENU_vy, ENU_vz = self.body2enu_velocity(msg.vector.x, msg.vector.y, msg.vector.z)
