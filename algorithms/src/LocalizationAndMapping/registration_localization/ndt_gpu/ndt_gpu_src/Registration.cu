...
void GRegistration::setInputTarget(pcl::PointCloud<pcl::PointXYZI>::Ptr input)
{
	if (input->size() > 0) {
        ...
        LOG(INFO)<<"check old pointer released"<<endl;
