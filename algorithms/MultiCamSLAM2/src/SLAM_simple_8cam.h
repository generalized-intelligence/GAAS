...
public:
    ...
    void iterateWith8Imgs(	shared_ptr<cv::Mat> img1,shared_ptr<cv::Mat> img2,shared_ptr<cv::Mat> img3,shared_ptr<cv::Mat> img4,
                                shared_ptr<cv::Mat> img5,shared_ptr<cv::Mat> img6,shared_ptr<cv::Mat> img7,shared_ptr<cv::Mat> img8
				)
    {
        ScopeTimer t("SLAM_simple::iterateWith8Imgs()");
        ...
        pvInputs->push_back(std::make_pair(img5,img6));
        pvInputs->push_back(std::make_pair(img7,img8));
