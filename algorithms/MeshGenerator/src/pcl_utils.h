...
//void img2d_to_mesh_3d(const cvMatT& original_img,const cv::Mat& depth_map,const cvMatT& render_helper,PointCloud<PointXYZRGB>& output_cloud,PointCloud<PointXYZRGB>& output_cloud2_debug,
