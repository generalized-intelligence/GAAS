...
class Commander:
    def __init__(self):
        rospy.init_node("uav3_commander_node")
        rate = rospy.Rate(20)
        self.position_target_pub = rospy.Publisher('/uav3/gi/set_pose/position', PoseStamped, queue_size=10)
        self.velocity_target_pub = rospy.Publisher('/uav3/gi/set_pose/velocity', Vector3Stamped, queue_size=10)
        self.yaw_target_pub = rospy.Publisher('/uav3/gi/set_pose/orientation', Float32, queue_size=10)
        self.custom_activity_pub = rospy.Publisher('/uav3/gi/set_activity/type', String, queue_size=10)
