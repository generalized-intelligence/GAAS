...
class Px4Controller:
    ...
    def __init__(self):
        ...
        self.set_target_velocity_sub = rospy.Subscriber("/uav4/gi/set_pose/velocity", Vector3Stamped, self.set_target_velocity_callback)
        ...
        ros publishers
        '''
        self.pose_target_pub = rospy.Publisher('/uav4/mavros/setpoint_position/local', PoseStamped, queue_size=10)
        self.twist_target_pub = rospy.Publisher('/uav4/mavros/setpoint_velocity/cmd_vel', TwistStamped, queue_size=10)
